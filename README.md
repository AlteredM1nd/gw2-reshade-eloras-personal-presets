...
2. **Copy the Preset**
   ...
   - You can either download the .ini files beginning with `Elora's Personal Presets` by clicking on them individually or click `Source code (zip)` to download my entire repository
