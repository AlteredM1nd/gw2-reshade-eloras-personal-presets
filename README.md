...
2. **Copy the Preset**
   - Place `Elora's Personal Presets - Standard - Third Person Photos.ini` into your Guild Wars 2 game folder (where `Gw2-64.exe` is located). (not required if you selected my .ini file in the first step)
