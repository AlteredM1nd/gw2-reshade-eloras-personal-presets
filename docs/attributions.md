...
- PD80 shaders by prod80 — MIT (in-file), e.g., `PD80_02_Bloom.fx`, `PD80_04_Color_Temperature.fx`.
...
- ZenteonFX by Daniel Oren‑Ibarra — All Rights Reserved. Do not redistribute without permission; link users to the upstream repository.
